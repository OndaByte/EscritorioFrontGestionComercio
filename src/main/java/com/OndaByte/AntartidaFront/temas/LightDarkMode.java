...
package com.OndaByte.AntartidaFront.temas;
...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonDark = new JButton("Dark",new IconSVG(IconSVG.OSCURO));
        buttonLight = new JButton("Light", new IconSVG(IconSVG.CLARO));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            ...
            buttonLighDark.setIcon(buttonDark.getIcon());
        } else {
            buttonLighDark.setIcon(buttonLight.getIcon());
        }
    }
