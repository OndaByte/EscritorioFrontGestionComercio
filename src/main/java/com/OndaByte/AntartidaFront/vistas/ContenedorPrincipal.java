...
import com.OndaByte.AntartidaFront.vistas.caja.MovimientoPanel;
import com.OndaByte.AntartidaFront.vistas.caja.MostradorCajaPanel;
import com.OndaByte.AntartidaFront.vistas.clientes.ClientePanel;
import com.OndaByte.AntartidaFront.vistas.empleados.EmpleadoPanel;
import com.OndaByte.AntartidaFront.vistas.gastosFijos.GastoFijoPanel;
import com.OndaByte.AntartidaFront.vistas.insumos.InsumoPanel;
import com.OndaByte.AntartidaFront.vistas.menuLateral.PanelLateral;
import com.OndaByte.AntartidaFront.vistas.ordenes.OrdenPanel;
import com.OndaByte.AntartidaFront.vistas.pedidos.PedidoPanel;
import com.OndaByte.AntartidaFront.vistas.presupuestos.PresupuestoPanel;
import com.OndaByte.AntartidaFront.vistas.remitos.RemitoPanel;
import com.OndaByte.AntartidaFront.vistas.turnos.TurnoPanel;
import com.OndaByte.AntartidaFront.vistas.usuarios.UsuarioTabs;
import com.OndaByte.AntartidaFront.vistas.dashboard.DashboardPanel;
import com.OndaByte.AntartidaFront.vistas.util.EventosInterface;
...
public class ContenedorPrincipal extends JLayeredPane implements ContenedorPrincipalView, EventosInterface {
    ...
    private void initBotoncito() {
        ...
        //String icon = (getComponentOrientation().isLeftToRight()) ? "menu_left.svg" : "menu_right.svg";
        //botoncito.setIcon(new FlatSVGIcon("com/OndaByte/AntartidaFront/icon/svg/9.svg", 0.8f));
    ...
    private void setMenuFull(boolean full) {
        ...
        //botoncito.setIcon(new FlatSVGIcon("com/OndaByte/AntartidaFront/icon/svg/" + icon, 0.8f));
