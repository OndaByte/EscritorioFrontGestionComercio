package com.OndaByte.AntartidaFront.vistas.menuLateral;
...
public class PopupSubmenu extends JPanel implements EventosInterface {
    ...
    public PopupSubmenu(ComponentOrientation orientation, PanelLateral menu, String menus[]) {
        this.menu = menu;
        this.menus = menus;
    ...
    private void init() {
        ...
        putClientProperty(FlatClientProperties.STYLE, "border:0,3,0,3; background:$Menu.background; foreground:$Menu.lineColor");
    ...
    private JButton createButtonItem(String text) {
        ...
        button.putClientProperty(FlatClientProperties.STYLE, MisEstilos.BOTON_MENU_ITEM_POPUP);
        return button;
    }
    ...
    public void runEvento(String evento) {
        MiFrame.getInstance().getAplicacion().runEvento(evento);
